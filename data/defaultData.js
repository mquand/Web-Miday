export const DEFAULT_COUPLE_INFO = {
  boyName: "Minh Quân",
...
export const DEFAULT_BUCKET_LIST = [
  { id: 1, text: "Cùng nhau ngắm bình minh trên bờ biển", completed: true, completedDate: "30/04/2024", category: "Du lịch" },
  { id: 2, text: "Nấu một bữa tối lãng mạn dưới ánh nến tại nhà", completed: true, completedDate: "20/10/2024", category: "Đời thường" },
  { id: 3, text: "Cùng nhau đi du lịch Đà Lạt mùa hoa dã quỳ", completed: true, completedDate: "02/05/2024", category: "Du lịch" },
